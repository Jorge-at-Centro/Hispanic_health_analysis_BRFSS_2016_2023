...
```{r Design set up, message=FALSE, warning=FALSE}
...
```{r Totals health, message=FALSE, warning=FALSE}
...
```{r Means and CI, message=FALSE, warning=FALSE}
...
```{r Testing Significance, message=FALSE, warning=FALSE}
