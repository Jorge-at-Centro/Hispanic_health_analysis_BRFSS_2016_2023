...
write.xlsx(totals_2016, "totals_2016_race_NY.xlsx")

totals_2023 <- svytable(~racexhisp, dsgn_2023, na.rm=TRUE)
write.xlsx(totals_2023, "totals_2023_race_NY.xlsx")
```
...
write.xlsx(total_2016_list, "totals_2016_hlth_list_NY.xlsx")

total_2023_list <- get_totals(dsgn_2023, health_vars)
write.xlsx(total_2023_list, "total_2023_hlth_list_NY.xlsx")
```
...
write.xlsx(mean_ci_2016_list, "mean_and_ci_2016_NY.xlsx")
write.xlsx(mean_ci_2023_list, "mean_and_ci_2023_NY.xlsx")
```
...
write.xlsx(all_ttest_results, "ttest_list_NY.xlsx")
```
